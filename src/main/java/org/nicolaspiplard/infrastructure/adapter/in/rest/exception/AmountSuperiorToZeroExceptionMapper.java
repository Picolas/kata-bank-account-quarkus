...
@Provider
public class AmountSuperiorToZeroExceptionMapper implements ExceptionMapper<AmountSuperiorToZeroException> {

    @Override
    public Response toResponse(AmountSuperiorToZeroException ex) {
